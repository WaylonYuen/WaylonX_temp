...
namespace WaylonXUnity.Controllers.Touch {
    ...
    public class ScreenPointToAnchoredPosition : ICoordinateTransformation {
        ...
        //Camera ICoordinateTransformation.Cam { get => m_camera; set => m_camera = value; }
        ...
        public Vector2 OffsetDirection() {
            ...
            switch (offsetDirection) {
                ...
                case Touch.OffsetDirection.None:
                    return Vector2.zero;

                case Touch.OffsetDirection.Bottom:
                    return new Vector2(rectOffset.x / 2f, 0f);
